...
const TasksCard: React.FC<Task> = ({
    ...
    return (
        <div
            className="w-full rounded-lg overflow-hidden shadow-lg p-6 bg-base-100 cursor-pointer transition duration-300 ease-in-out transform hover:scale-105 relative"
            onClick={onClick}
        >
