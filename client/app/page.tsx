            ...
            <section id="pricing" className="py-20 md:py-32 relative bg-gradient-to-b from-transparent to-gray-900/10">
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        ...
                        {/* Pro Plan - simplified but still highlighted */}
                        <motion.div
                            initial={{opacity: 0, y: 20}}
                            whileInView={{opacity: 1, y: 0}}
                            transition={{duration: 0.5, delay: 0.1}}
                            viewport={{once: true}}
                            className="bg-gray-900/30 border border-cyan-900/30 rounded-lg overflow-hidden relative transform scale-105 shadow-md z-10"
                        >
                            <div
                                className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-cyan-500 to-blue-600"/>
                            <div className="p-6">
                                <div
                                    className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs font-medium px-2 py-0.5 rounded-md inline-block mb-4">
                                    MOST POPULAR
                                </div>
                                ...
                                <Link href="/register">
                                    <motion.button
                                        ...
                                        whileTap={{scale: 0.98}}
                                        className="w-full py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium shadow-sm text-sm"
                                    >
                                        Get Started
                                    </motion.button>
                                </Link>
