...
const SessionCards = () => {
    ...
    const handleRemoveSession = async () => {
        ...
        try {
            ...
            setSessions((prevSessions) => prevSessions.filter((session) => session.tokenDTO.token !== sessionToRemove))
                                        ...
                                        <div className="flex gap-6">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    <h3 className="text-lg font-semibold text-white">{session.platform}</h3>
                                                    {isCurrentSession && (
                                                        <span
