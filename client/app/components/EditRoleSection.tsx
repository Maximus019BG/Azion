...
const EditRoleSection: React.FC<EditRoleSectionProps> = ({RoleName}) => {
    ...
    return (
        <div className="size-full bg-base-300 flex flex-col lg:flex-row">
                            ...
                            <div className="p-4 flex items-center justify-between">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 mt-1 font-mono">{field.permission}</div>
                                    </div>
                                </div>
            ...
            <div className="w-full lg:w-1/4 p-4 bg-gray-750 lg:bg-transparent lg:border-l border-gray-700">
