...
const VideoChatComponent = ({remoteUserId, onClose}: VideoChatProps) => {
    ...
    return (
        ...
        >
            <Card
                className="mb-6 bg-[#1e293b]/40 backdrop-blur-sm border border-gray-700/30 shadow-[0_0_25px_rgba(14,165,233,0.07)]">
                ...
                {isReceivingCall ? `Incoming call from: ${callerId}` : `Remote user: ${remoteUserId || "Not selected"}`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div
                            className="relative overflow-hidden rounded-lg border border-gray-700/50 bg-black/50 aspect-video shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                            <div
                                className="absolute top-2 left-2 z-10 px-2 py-1 bg-black/60 rounded-md text-xs font-medium text-gray-300">
                            ...
                            {isScreenSharing && (
                                <div
                                    className="absolute bottom-2 right-2 z-10 px-2 py-1 bg-blue-500/80 rounded-md text-xs font-medium text-white">
                                    Screen sharing
                                </div>
                            )}
                        </div>
                        ...
                        <div
                            ...
                            {isDeafened && remoteStream && (
                                <div
                                    className="absolute top-2 right-2 z-10 px-2 py-1 bg-red-500/80 rounded-md text-xs font-medium text-white flex items-center gap-1">
                        ...
                        {isReceivingCall ? (
                            ...
                            >
                                <div className="text-center mb-6">
                                    ...
                                    {callTimeoutSeconds !== null && (
                                        <p className="text-yellow-400 text-sm mt-1">Auto-reject
                                            in {callTimeoutSeconds}s</p>
                                    )}
                                </div>
                                ...
                                <div className="flex flex-wrap justify-center gap-4">
                                    <Button
                                        ...
                                        className="bg-green-600 hover:bg-green-700 text-white shadow-[0_0_15px_rgba(22,163,74,0.3)] hover:shadow-[0_0_20px_rgba(22,163,74,0.4)]"
                                        size="lg"
                                    >
                                ...
                                {isCalling && (
                                    <>
                                        ...
                                        >
                                            {!isScreenSharing ? (
                                                <>
                                                    <MonitorSmartphone className="mr-2 h-5 w-5 text-blue-400"/> Share
                                                    Screen
                                                </>
                                            ) : (
                                                <>
