...
import DashboardMeetingCardRow from "@/components/_Dashboard-Elements/Dashboard_Meeting_Card_Row";
...
const DashboardProgramCard: React.FC<DashboardProgramCardProps> = ({meetings}) => {
    ...
    return (
        <div className="w-full h-full bg-[#090909] rounded-md flex flex-col relative">
            ...
            <div
                className="absolute w-fit h-full flex flex-col justify-around items-center left-0 text-gray-500 top-10">
