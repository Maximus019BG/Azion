...
const ConString: React.FC<ConStringProps> = ({value, name}) => {
    ...
    return (
        <div
            className="w-full h-full flex flex-col justify-center items-center gap-8 bg-slate-950 rounded-badge max-w-full">
            <h1
                className={`text-white max-w-2xl text-md md:text-xl lg:text-3xl text-center`}
            >
                <span className=" font-black text-lightAccent text-lg md:text-3xl lg:text-5xl">Congrats!!!</span> <br/>
